...
import '../Styles/champion-card.scss'
...
const ChampionCard = props => {
    ...
    const onClick = () => {
        ...
        const pos = img.getBoundingClientRect() //cho phep lay kich thuoc
        const newNode = img.cloneNode(true) //nhan ban copy
    ...
    return (
        <div className="champion-card" onClick={onClick} ref={cardRef}>
            ...
            <div className="name">{item.name} asdasdasd</div>
        </div>
    )
}
