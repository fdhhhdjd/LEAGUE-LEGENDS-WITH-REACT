import '../Styles/champion-detail.scss'

import { closeIcon } from '../import/Image'
        ...
        >
            <div className="champion-detail__content">
                ...
                <div className="video">
                    ...
                    <iframe src="http://example.com" frameborder="0" width="100%"   title="champion spotlight"
                        ref={iframeRef} allowFullScreen></iframe>
                </div>
            </div>
